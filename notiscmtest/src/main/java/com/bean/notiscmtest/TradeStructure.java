...
package com.bean.notiscmtest;

import com.util.notistest.Utility;
...
public class TradeStructure {
    ...
    public String getTrdTm() throws ParseException {
        ...
        long num = Long.parseLong(trdTm);
        String tradeTime=Utility.getDateFromJiffy(num);
        return tradeTime;
    }
    ...
    public String getActTyp() {
        ...
        switch (actTyp) {
            ...
            case "7":
                ...
                break;
            case "5":
                ActivityType = "Client Modification Pre-Image";
                break;
                case "27":
                ActivityType = "Client Modification Post-Image";
                break;
                    case "101":
    ...
    public String getOrdTm() {
        ...
        long num = Long.parseLong(ordTm);
        String orderTime=Utility.getDateFromNonJiffy(num);
        return orderTime;
    }
    ...
    public String getMktTyp() {
        ...
        switch (mktTyp) {
            ...
            default:
                book=mktTyp;
                System.out.println("Market Book Type ?");
        }
        return book;
    }
